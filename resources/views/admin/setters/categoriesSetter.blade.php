    ...
    <div class="admin-setter__content">
        ...
        <form method="post" action='{{$vars->actionRoute}}' class="form-group admin-setter__form">
            <div>
                ...
                <input required type="text" value="{{$vars->model->title}}" class="form-control admin-setter__input" name="title" id="title">
                <label class="admin-setter__label" for="description">Краткое описание</label>
                <textarea class="form-control admin-setter__input" id="description" required rows="4" name="description">{{$vars->model->description}}</textarea>
